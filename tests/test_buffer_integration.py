...
class TestBufferIntegration:
    ...
    def test_full_insert_cycle_with_get_all(self):
        ...
        """
        buf = Buffer(step=20, state_shape=(8,), action_shape=(4,))
        for i in range(20):
        ...
        result = buf.get_all()
        assert len(result) == 8
        states, actions, old_log_probs, ret, a, rewards, values, dones = result
    ...
    def test_buffer_scalar_actions(self):
        ...
        states, actions, _, _, _, rewards, _, _ = buf.get_all()
    ...
    def test_buffer_multidim_states(self):
        ...
        states, _, _, _, _, _, _, _ = buf.get_all()
    ...
    def test_buffer_with_different_state_action_shapes(self):
        ...
        s1, a1, _, _, _, _, _, _ = buf1.get_all()
        assert s1.shape == (3, 2)
        assert a1.shape == (3, 1)
        ...
        s2, a2, _, _, _, _, _, _ = buf2.get_all()
